        ...
        <div class="container">
            ...
            <table class="table table-bordered mt-3 list dataTables-example" id="links-table">
                ...
                <tr>
                    ...
                    <th style=" border: 1px solid #1b1e21;">تصویر 3</th>
                </tr>
                </thead>
                <tbody>
                ...
                <tr>
                    ...
                    <td style=" border: 1px solid #1b1e21;">
                        <img src="{{url('slider/slider1.jpg')}}" height="60" width="130">
                    </td>

                    <td style=" border: 1px solid #1b1e21;">
                        <img src="{{url('slider/slider2.jpg')}}" height="60" width="130">
                    </td>

                    <td style=" border: 1px solid #1b1e21;">
                        <img src="{{url('slider/slider3.jpg')}}" height="60" width="130">
                    </td>
