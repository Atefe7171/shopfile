    ...
    <div class="container text-center text-md-left">
        <div class="row">
            <div class="col-md-4 col-lg-3 mr-auto my-md-4 my-0 mt-4 mb-1">
                <h5 class="font-weight-bold text-uppercase mb-4">درباره سايت  ما</h5>
                <p>آموزش نرم افزار مختلف و طراحي و گرافيک</p>
            </div>
            ...
            <div class="col-md-2 col-lg-2 mx-auto my-4">
                <h5 class="font-weight-bold text-uppercase mb-4">شبکه اجتماعي</h5>
...
<script src="{{url('js/front/popper.min.js')}}"></script>
